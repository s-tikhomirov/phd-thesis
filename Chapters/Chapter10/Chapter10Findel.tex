...
Ethereum contracts can not act independently: the owner must issue a transaction to trigger contract execution.
...
In the three years since the original paper's publication, the market has shown that fully collateralized (and \textit{over}collateralized) loans do have useful applications.
