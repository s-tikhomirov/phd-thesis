...
\section{Privacy-efficiency trade-off}
...
This constitutes a \textit{privacy-efficiency trade-off}: hidden balances improve privacy but hinder routing efficiency.
We argue that the way LN is currently addressing this trade-off suboptimal.
...
Our later results show that this is a reasonable trade-off between probing speed and accuracy.
...
We consider the trade-off between balance privacy and routing efficiency, and describe multiple directions for future work that would evaluate the ways to find the right balance between the two.
