...
Section~\ref{sec:Ch03Background} provides an overview of the propagation mechanisms in various cryptocurrencies.
Section~\ref{sec:Ch03Ourapproach} describes our approach to transaction clustering based on propagation timing.
...
Section~\ref{sec:Ch03Relatedwork} provides an overview of related work, and Section~\ref{sec:Ch03Conclusion} summarizes and suggests future work.


\section{Background} \label{sec:Ch03Background}
...
\section{Our approach}  \label{sec:Ch03Ourapproach}
...
A promising proposal for anonymous peer-to-peer broadcast is Dandelion~\cite{Venkatakrishnan2017, Fanti2018} (see Section~\ref{sec:Ch03Relatedwork} for an overview).


\section{Related work}  \label{sec:Ch03Relatedwork}
...
\section{Conclusion and future work} \label{sec:Ch03Conclusion}
