...
\usepackage[backend=bibtex,style=numeric,natbib=true,urldate=iso]{biblatex}
...
\hyphenation{Chapter Table Figure Figures Algorithm Section Sections Part}
...
\graphicspath{{Chapters/Chapter03/figures/}{Chapters/Chapter05/figures/}{Chapters/Chapter06/figures/}{Chapters/Chapter07/figures/}{Chapters/Chapter08/figures/}{Chapters/Chapter12/figures/}}
...
\university{University of Luxembourg} % Your university's name and URL, this is used in the title page and abstract, print it elsewhere with \univname
...
\group{CryptoLUX Research Group} % Your research group's name and URL, this is used in the title page, print it elsewhere with \groupname
\faculty{Faculty of Science, Technology and Medicine} % Your faculty's name and URL, this is used in the title page and abstract, print it elsewhere with \facname
...
%\pagestyle{empty} % empty headers and footers
