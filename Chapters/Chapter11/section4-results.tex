...
SmartCheck analyzed the dataset in approximately $2$~hours and~$7$~minutes.\footnote{$7\,644$~seconds, or $437$~lines per second on Intel~Core~i5-4210M @ 2.60~GHz, 12~GB RAM, Windows~8.1 64~bit.}
