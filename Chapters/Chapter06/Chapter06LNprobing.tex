...
Hanging HTLCs are hard to get rid of.
...
In our main experiment, we performed $12895$~payments.
We rejected $96768$~routes because of low balance.
...
In total, we sent $12895$~probes: $3153$~($24.45\%$) during the pre-probing and $9742$~($75.55\%$) during the main probing phase.
