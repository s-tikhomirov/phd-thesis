...
The LN is a prominent Bitcoin-based protocol that aims to alleviate this issue.
It performs low-latency transactions \textit{off-chain} but leverages Bitcoin's security guarantees for dispute resolution.
