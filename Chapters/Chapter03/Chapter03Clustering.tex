...
While multiple research works propose deanonymization techniques for cryptocurrencies, few of them quantify their results based on ground truth data, i.e.,~by deanonymizing transactions known to have originated from one source.
