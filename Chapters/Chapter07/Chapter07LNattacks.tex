...
as several channels can be shared by two LN nodes.
...
We refer to this dataset as \textit{LNHist} and use it in our experiments in Chapter~\ref{Chapter08HTLClimit}.
\todo[inline]{Move to Chapter08}
...
prone to the specific attack depends on the type of the attack:
\begin{itemize}
...
We envision thus that there is a trade-off between connectivity on the one hand and security and privacy on the other,
...
Our results suggest that, although largely omitted so far, 
the security and privacy attacks here studied are a crucial variable to consider when designing routing protocols. 


\section{Related work}

Multiple research works have shed light on various aspects of payment-channel networks, such as security~\cite{Malavolta2019, Kiayias2019}, privacy~\cite{Malavolta2017, HerreraJoancomarti2019, Kohen2019}, concurrency~\cite{Malavolta2017}, routing~\cite{Malavolta2017a, Roos2018, Sivaraman2018, Prihodko2016}, liquidity~\cite{Dandekar2011,MorenoSanchez2018}, efficiency~\cite{Decker2018}, and incentive compatibility~\cite{Engelmann2017}.
...
the trade-offs between balance privacy and routing effectiveness. 
