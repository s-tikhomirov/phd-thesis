...
Besides, it can change the state of some third contract, which \texttt{Fund} depends on.
...
The pattern simply detects the \texttt{library} keyword (thus producing some false positives).
